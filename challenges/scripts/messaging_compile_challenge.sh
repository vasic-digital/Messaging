#!/usr/bin/env bash
# messaging_compile_challenge.sh - Validates Messaging module compilation and code quality
set -euo pipefail
...
echo "Test: Module name is digital.vasic.messaging"
if grep -q "^module digital.vasic.messaging$" "${MODULE_DIR}/go.mod"; then
    pass "Module name is digital.vasic.messaging"
else
