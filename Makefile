# Messaging - Generic, reusable Go module for message broker abstractions and adapters.
...
challenge:
	../challenges/scripts/messaging_challenge.sh 2>/dev/null || echo "No challenge script"

help:
	@echo "Messaging - Generic, reusable Go module for message broker abstractions and adapters."
	@echo ""
	@echo "Build & Test:"
